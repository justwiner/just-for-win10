<template>
    <transition name="mei-message-fade">
        ...
        type? `mei-message-${ type }` : '']">
            <svg v-if="type=='error'" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" t="1515656768815"
                style="" viewBox="0 0 1024 1024" version="1.1" p-id="2794" width="20" height="20">
                <path
                ...
                <path
                    ...
                    p-id="2797" fill="#ffffff"/>
            </svg>
            <svg v-if="type=='success'" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" t="1515656188050"
                style="" viewBox="0 0 1024 1024" version="1.1" p-id="2186" data-spm-anchor-id="a313x.7781069.0.i11"
                width="20" height="20">
                <path
...
<style lang="scss" rel="stylesheet/scss">
    .mei-message {
        ...
        animation: message-show .3s forwards;
        overflow: hidden;
        padding: 0 15px;
